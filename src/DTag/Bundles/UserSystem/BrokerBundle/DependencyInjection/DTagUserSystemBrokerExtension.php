 ...
 */
class DTagUserSystemBrokerExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        /*
            ...
            Will internally get converted to an 'd_tag_user_system_broker_profile' form-type service definition.
            Never set the template namespace to FOSUserBundle or RollerworksMultiUserBundle as this will create an endless recursion!
        */

        $factory->create('d_tag_user_system_broker', array(
            array(
                /*
                ...
                'services_prefix' => 'd_tag_user_system_broker',
                'routes_prefix' => 'd_tag_user_system_broker',

                'db_driver' => 'orm', // can be either: orm, mongodb, couchdb or custom (Propel is not supported)
                'model_manager_name' => 'default',
                'use_listener' => true,

                'user_class' => 'DTag\Bundles\UserSystem\BrokerBundle\Entity\User',
                ...
                /*
                'group' => array(
                    'group_class' => 'DTag\Bundles\UserSystem\BrokerBundle\Entity\Group',
